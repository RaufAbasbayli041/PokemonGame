...
namespace PokemonGame_Domain.Entities
{
    public class BattleTurn : BaseEntity
    {
        ...
        public Battle Battle { get; set; } // Navigation property to the Battle entity
        public int AttackerId { get; set; } // ID of the attacking Pokemon
        public TrainerPokemon Attacker { get; set; } // Navigation property to the attacking Pokemon
        public int DefenderId { get; set; } // ID of the defending Pokemon
        public TrainerPokemon Defender { get; set; } // Navigation property to the defending Pokemon
